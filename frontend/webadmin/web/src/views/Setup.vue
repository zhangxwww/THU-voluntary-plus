<template>
    <div>
        <el-steps :space="300" :active="step" finish-status="success" label-width="80px">
        ...
        <el-form v-if="step === 0" style="margin-top: 20px; width: 50%" label-position="top">
            <el-form-item label="团体名称">
                <el-input v-model="descriptions.name"></el-input>
            </el-form-item>
            <el-form-item label="成立时间">
                <el-col :span="11">
                    <el-date-picker type="date" placeholder="选择日期" v-model="descriptions.setuptime"
        ...
        <el-form
                v-if="step === 1"
                autosize
                style="margin-top: 20px; width: 50%" label-position="top">
            <el-form-item label="团体简介">
                <el-input rows="10" type="textarea" v-model="descriptions.about"></el-input>
            </el-form-item>
            <el-form-item>
        ...
        <el-form v-if="step === 2" style="margin-top: 20px" label-position="top">
            ...
            <el-row style="margin-bottom: 20px;" v-for="member in descriptions.members" :key="member.name">
                <el-tag
                        block
                        closable
                        type="info"
    ...
    export default {
        ...
        methods: {
            ...
            handleClose: function (member) {
                this.descriptions.members.splice(this.descriptions.members.indexOf(member), 1)
            }
        }
    }
</script>
