<template>
  <div>
    ...
    <el-form v-if="step === 0"
      ...
      <el-form-item>
        <el-button type="primary"
                   @click="handleSubmit(1)">下一步</el-button>
      </el-form-item>
    </el-form>
    ...
    <el-form v-if="step === 1"
      ...
      <el-form-item>
        <el-button type="primary"
                   @click="handleSubmit(2)">下一步</el-button>
      </el-form-item>
    </el-form>
    ...
    <el-form v-if="step === 2"
      ...
      <el-row style="margin-top:30px">
        <el-input style="width: 120px;margin-right: 30px;"
                  v-if="inputVisible"
        ...
        <div v-else>
          <el-button type="primary"
                     @click="showInput">+ 新成员</el-button>
          <el-button type="success"
                     @click="handleSubmit(3)">下一步</el-button>
        </div>
      </el-row>
    </el-form>
  </div>
